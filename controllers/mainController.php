<?php
	...
	class mainController extends mainModel{
		...
		public function update_account_controller(){
			...
			if($oldusername!=$username){
				...
				if($query1->rowCount()>0){
					$dataAlert=[
						"title"=>"¡Ocurrió un error inesperado!",
						"text"=>"Este nombre de usuario ya se encuentra registrado en el sistema por favor elija otro",
						"type"=>"error"
					];
					return self::sweet_alert_single($dataAlert);
					exit();
		...
		public function consultas_list_controller(){
		// la vista de historial está en views/contents
		require_once __DIR__ . '/../views/contents/consultaslist-view.php';
		}
