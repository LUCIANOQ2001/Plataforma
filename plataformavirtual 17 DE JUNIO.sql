...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2025 a las 23:04:49
...
INSERT INTO `actividad` (`id`, `sesion_id`, `Titulo`, `Descripcion`, `FechaInicio`, `FechaCierre`, `Archivo`) VALUES
(1, 11, 'ACTIVIDAD 1', 'SUBIR EL TRABAJO EN PDF', '2025-06-16', '2025-06-17', NULL),
(18, 7, 'aaaaaaaaa', '', '2025-06-16', '2025-06-17', 'QUIROZ-LACERNA-TRABAJO_DE_INVESTIGACION-solocontenido__1_.pdf');
...
(23, 7, '682fa098dcf14', '2025-06-12 17:43:22', 'ausente'),
(24, 12, '682fa098dcf14', '2025-06-12 18:02:12', 'ausente');
...
(53, '682fa098dcf14', '2025-06-12 18:32:33', 'Consulta uno', 'holaa', 'pendiente');
...
(26, 2, 'admin04', 'RHduVEdGR3NrWGt3Z3lEQzVLeTdCZz09', 'Docente', 'Masculino', 'AC747142713'),
...
INSERT INTO `curso` (`id`, `Nombre`, `Descripcion`, `FechaInicio`, `FechaFin`, `DocenteCodigo`) VALUES
(12, 'INVESTI', 'ADAD', '2025-06-16', '2025-07-16', 'AC50913775'),
(13, 'INVESTI', 'ADAD', '2025-06-16', '2025-07-16', 'AC50913775'),
(14, 'REDES', 'Esta clase dictará redes e informatica', '2025-06-16', '2025-07-16', 'AC68948906'),
(15, 'REDES', 'Esta clase dictará redes', '2025-06-16', '2025-07-16', 'AC744869210'),
(16, 'INFORMATICA', 'SE DICTARA INFO', '2025-06-16', '2025-07-16', 'AC33902998'),
(17, 'INFORMATICA', 'SE DICTARA INFO', '2025-06-16', '2025-07-16', 'AC33902998'),
(18, 'INFOOOO', '124', '2025-06-16', '2025-07-16', 'AC813028115'),
(23, 'holasoy', 'hola', '2025-06-16', '2025-07-16', 'AC747142713'),
(24, 'CURSO PRUEBA', 'HOLA PROBANDO', '2025-06-16', '2025-07-16', 'AC747142713'),
(25, 'PROBANDO CURSOOO', 'ANTE TODO BUENAS TARDES', '2025-06-16', '2025-07-16', 'AC080139916');
...
('AC747142713', 'DOCENTE', 'DOCENTE', 'DOCENTE@GMAIL.COM'),
...
('682fa098dcf14', 'Luciano', 'Quiroz', 'asd@gmail.com'),
...
CREATE TABLE `evaluacion` (
  ...
  `IntentosPermitidos` int(11) NOT NULL DEFAULT 1,
  `DuracionMinutos` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `evaluacion` (`id`, `SesionId`, `Titulo`, `FechaInicio`, `FechaCierre`, `IntentosPermitidos`, `DuracionMinutos`, `FechaCreacion`) VALUES
(8, 7, 'EXAMEEEN', '2025-06-05 16:06:00', '2025-06-06 16:00:00', 1, 50, '2025-06-05 16:06:44'),
(9, 7, 'Evaluacion 2', '2025-06-11 17:55:00', '2025-06-11 17:58:00', 1, 50, '2025-06-11 17:56:08'),
(10, 7, 'Evaluación 3', '2025-06-11 18:01:00', '2025-06-11 18:04:00', 1, 12, '2025-06-11 18:01:44');
...
(4, 7, 'PROBANDO', 'PRUEBITA', '2025-06-04 11:16:42', '2025-06-26 11:16:00', '1749059220_Screenshot_1.png'),
(5, 8, 'FOROOO', 'RESPONDER FOROOO', '2025-06-04 16:02:01', '2025-06-27 20:01:00', '1749070921_Screenshot_1.png');
...
(12, 4, '682fa098dcf14', 'Hola', NULL, '2025-06-04 12:24:59'),
(13, 4, 'AC747142713', 'Hola', NULL, '2025-06-04 12:29:35'),
(14, 4, '682fa098dcf14', 'Adjunto mi trabajo en word', '1749059250_LOGO_CIP.ico', '2025-06-04 12:47:30');
...
INSERT INTO `grabacion` (`id`, `sesion_id`, `archivo`, `fecha`) VALUES
(14, 7, '1749684581_ChatGPT Image 10 jun 2025, 16_20_06.png', '2025-06-11 18:29:41'),
(15, 7, '1749685115_ChatGPT_Image_10_jun_2025__16_20_06.png', '2025-06-11 18:38:35');
...
(17, 11, 'Material 1', '1749162881_Screenshot_2.png', '2025-06-05 17:34:41');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `nota_sesion`
--
...
--
-- Volcado de datos para la tabla `nota_sesion`
--

INSERT INTO `nota_sesion` (`id`, `CursoId`, `SesionId`, `EstudianteCodigo`, `Nota`, `Fecha`) VALUES
(1, 23, 7, '682fa098dcf14', 12.00, '2025-06-12 18:28:08'),
(2, 23, 12, '682fa098dcf14', 11.00, '2025-06-12 18:28:08'),
(3, 23, 8, '682fa098dcf14', 11.00, '2025-06-12 18:28:08');
...
(7, 8, '', 15, 43, '2025-06-05 16:33:26'),
(8, 9, '', 16, 49, '2025-06-11 17:56:27'),
(9, 10, '', 17, 53, '2025-06-11 18:02:52');
...
(5, 8, '', 0.00, '2025-06-05 16:33:26'),
(6, 9, '', 100.00, '2025-06-11 17:56:27'),
(7, 10, '', 100.00, '2025-06-11 18:02:52');
...
INSERT INTO `sesion` (`id`, `CursoId`, `Titulo`, `Fecha`, `FechaFin`, `Video`) VALUES
(1, 13, 'SESÓN 1', '2025-06-12 00:00:00', '2025-06-12 00:00:00', ''),
(2, 13, 'A', '2025-05-17 00:00:00', '2025-05-17 00:00:00', ''),
(3, 13, 'SESIÓN 2', '2025-05-31 00:00:00', '2025-05-31 00:00:00', 'https://meet.google.com/wfr-gpjv-jhc?authuser=0'),
(4, 12, 'SESIÓN 01', '2025-05-25 00:00:00', '2025-05-25 00:00:00', 'https://meet.google.com/landing?authuser=0'),
(5, 13, 'SEXOOOO', '2025-05-26 00:00:00', '2025-05-26 00:00:00', 'https://meet.google.com/vkx-biks-oku'),
(6, 12, 'SEXOOO', '2025-05-27 00:00:00', '2025-05-27 00:00:00', 'https://quillbot.com/es/parafrasear'),
(7, 23, 'SESIÓN 01', '2025-05-30 00:00:00', '2025-05-30 00:00:00', 'https://www.youtube.com/'),
(8, 23, 'SESIÓN 02', '2025-06-24 00:00:00', '2025-06-24 00:00:00', '1245'),
(9, 24, 'SESIÓN 01', '2025-05-31 00:00:00', '2025-05-31 00:00:00', ''),
(10, 25, 'PRIMERO LA EDUCACIÓN XD', '2025-05-31 00:00:00', '2025-05-31 00:00:00', 'https://workspace.google.com/products/meet/'),
(11, 24, 'SESIÓN 02', '2025-05-18 00:00:00', '2025-05-18 00:00:00', ''),
(12, 23, 'SESIÓN 03', '2025-06-17 00:00:00', '2025-06-17 00:00:00', ''),
(13, 23, 'SESIÓN 04', '2025-07-15 00:00:00', '2025-07-15 00:00:00', 'https://www.google.com/search?sca_esv=b18e3948b1808f06&q=dashboard&udm=2&fbs=AIIjpHx4nJjfGojPVHhEACUHPiMQht6_BFq6vBIoFFRK7qchKEWEvuc0Hbw31oEI7c8o3y5Az9dJyKxsfx0xXZG1h0pUgSbCYZ7LGbQzQzm8Hq47-Vzc87SrlfKvH7PgQOKVluGNbFLVH4pG30ll_nvoNwbkn_ze-MCML5jIx3-BRKwD-ilweKijP97T8F11LghyWBPZx8VmHlTMPrIH8Ks3DDwXxvRhBg&sa=X&sqi=2&ved=2ahUKEwiLnc7J9u6NAxVtLrkGHYgoIHMQtKgLegQIFRAB&biw=1536&bih=703&dpr=1.25#vhid=GZDD0HjfHa2-MM&vssid=mosaic');
...
ALTER TABLE `actividad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_actividad_sesion` (`sesion_id`);
...
ALTER TABLE `entrega_actividad`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_entrega_actividad` (`actividad_id`,`EstudianteCodigo`),
  ADD KEY `fk_entrega_act_actividad` (`actividad_id`),
  ADD KEY `fk_entrega_act_estudiante` (`EstudianteCodigo`);
...
--
-- Indices de la tabla `nota_sesion`
--
ALTER TABLE `nota_sesion`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_nota` (`SesionId`,`EstudianteCodigo`),
  ADD KEY `fk_ns_curso` (`CursoId`),
  ADD KEY `fk_ns_sesion` (`SesionId`),
  ADD KEY `fk_ns_estudiante` (`EstudianteCodigo`);
...
--
-- AUTO_INCREMENT de la tabla `nota_sesion`
--
ALTER TABLE `nota_sesion`
...
--
ALTER TABLE `actividad`
  ADD CONSTRAINT `fk_actividad_sesion` FOREIGN KEY (`sesion_id`) REFERENCES `sesion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `entrega_actividad`
  ADD CONSTRAINT `fk_entrega_act_actividad` FOREIGN KEY (`actividad_id`) REFERENCES `actividad` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_entrega_act_estudiante` FOREIGN KEY (`EstudianteCodigo`) REFERENCES `estudiante` (`Codigo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `nota_sesion`
--
ALTER TABLE `nota_sesion`
  ADD CONSTRAINT `fk_ns_curso` FOREIGN KEY (`CursoId`) REFERENCES `curso` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ns_estudiante` FOREIGN KEY (`EstudianteCodigo`) REFERENCES `estudiante` (`Codigo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ns_sesion` FOREIGN KEY (`SesionId`) REFERENCES `sesion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
