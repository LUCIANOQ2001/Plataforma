    ...
    <ul class="list-unstyled full-box dashboard-sideBar-Menu">
      ...
      <?php else: ?>
        ...
        <li>
          ...
          <ul class="list-unstyled full-box submenu">
            <!-- Apuntamos al mismo /miscursos/ que maneja ambos roles -->
            <li><a href="<?php echo SERVERURL; ?>miscursos/">Mis Cursos</a></li>
          </ul>
        </li>
        ...
        <li>
          <a href="#!" class="btn-sideBar-SubMenu">
            <i class="zmdi zmdi-comment-text zmdi-hc-fw"></i> Consultas Generales <i class="zmdi zmdi-caret-down pull-right"></i>
          </a>
          <ul class="list-unstyled full-box submenu">
